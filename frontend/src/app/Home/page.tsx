...
import NotesView from "@/app/Notes/page"
...
import TaskManager from "../Task/page"
import CalendarTasksPage from "../Calendar/page"
...
export default function Home() {
  ...
  const handleUpdateProfile = async () => {
    if (!user) return
    try {
      const response = await updateUser(user.user_id, profileData)
  ...
  return (
    <div className="flex flex-col h-screen overflow-hidden bg-background">
      ...
      <div className="flex-1 overflow-auto">
        ...
        {activeTab === "calendar" && <CalendarTasksPage />}
